        ...
        <form action="{{ route('question.store')}}" method="post">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text"
                class="form-control @error('question_title') is-invalid @enderror" value="{{ old('question_title') }}" name="question_title" id="question_title" aria-describedby="helpId" placeholder="Masukan judul ujian">
